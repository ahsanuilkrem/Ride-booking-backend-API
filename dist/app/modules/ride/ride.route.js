...
router.get("/rideHistory/:rideId", (0, checkAuth_1.checkAuth)(user_interfaces_1.Role.RIDER), ride_controler_1.rideControler.getRideById);
router.patch("/cancel/:rideId", (0, checkAuth_1.checkAuth)(user_interfaces_1.Role.RIDER), ride_controler_1.rideControler.cancelRide);
