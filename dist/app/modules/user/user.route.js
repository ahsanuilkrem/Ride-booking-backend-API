...
router.patch("/:id", (0, checkAuth_1.checkAuth)(...Object.values(user_interfaces_1.Role)), 
//  validateRequest(updateUserZodSchema), 
user_controler_1.UserControllers.updateUser);
router.patch('/block/:id', (0, checkAuth_1.checkAuth)(user_interfaces_1.Role.ADMIN), validateRequest(user_validation_1.updateUserZodSchema), user_controler_1.UserControllers.Userblock);
...
router.patch("/updateUser/:id", (0, checkAuth_1.checkAuth)(...Object.values(user_interfaces_1.Role)), 
// validateRequest(updateUserZodSchema), 
user_controler_1.UserControllers.updateUserProfile);
